...
- **`--install-dir <directory>`** *(required)*: Absolute path where the instance will be installed.
...
- Select a blueprint.
- Provide an installation directory.
...
| **Issue**                                 | **Resolution**                                              |
| ----------------------------------------- | ----------------------------------------------------------- |
| Missing installation directory            | Provide `--install-dir`.                                    |
