...
function test_management_file_create_and_verify() {
  ...
  assert_file_executable "$manage_file" \
    "Management file should have execute permission"
...
function main() {
  log_test_step "Starting files management E2E tests"

  setup_test

  # Management file tests
  test_management_file_create_and_verify
  test_management_file_create_fails_for_invalid_instance
  test_management_file_remove
  test_management_file_remove_fails_for_invalid_instance

  # Orchestrator tests
  test_files_orchestrator_creates_management_file
  test_files_orchestrator_removes_management_file
  test_files_orchestrator_fails_for_invalid_instance

  # Config-dependent integration tests
  test_systemd_respects_config
  test_ufw_fails_for_invalid_instance
  test_upnp_enable_disable
  test_upnp_fails_for_invalid_instance
  test_systemd_fails_for_invalid_instance
  ...
  log_test_step "Files management E2E tests completed"

  if print_assert_summary "$TEST_NAME"; then
    pass_test "All files management E2E tests passed"
  else
    fail_test "Some files management E2E tests failed"
  fi
}
