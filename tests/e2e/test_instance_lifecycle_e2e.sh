...
function main() {
  log_test_step "Starting instance lifecycle E2E tests"

  setup_test

  # Core lifecycle workflow tests
  test_instance_creation_from_blueprint
  test_directory_creation
  test_management_file_creation
  test_instance_info_readable
  test_instance_appears_in_list
  test_files_removal
  test_directory_removal
  test_instance_removal

  # Full end-to-end workflow
  test_complete_lifecycle

  # Negative cases
  test_duplicate_instance_creation_fails
  test_invalid_blueprint_fails
  test_lifecycle_commands_on_stopped_instance

  log_test_step "Instance lifecycle E2E tests completed"

  if print_assert_summary "$TEST_NAME"; then
    pass_test "All instance lifecycle E2E tests passed"
  else
