...
function main() {
  log_test_step "Starting files.upnp commands tests"
  ...
  test_enable_on_valid_instance
  test_disable_on_valid_instance
  test_enable_then_disable_on_valid_instance

  log_test_step "Files.upnp commands tests completed"

  if print_assert_summary "$TEST_NAME"; then
    pass_test "All files.upnp commands tests passed"
  else
    fail_test "Some files.upnp commands tests failed"
  fi
}
