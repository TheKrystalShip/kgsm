...
function main() {
  log_test_step "Starting events commands tests"
  ...
  test_help_emit_subcommand
  test_help_socket_subcommand
  test_help_webhook_subcommand
  ...
  # test subcommand tests
  test_test_no_args_fails
  test_test_no_args_shows_usage
  test_test_help_flag
  test_test_help_command
  test_test_all_no_transports_fails
  test_test_all_no_transports_shows_error
  test_test_invalid_transport_fails
  test_test_invalid_transport_error_message

  # emit tests (broadcasting disabled)
  test_emit_help_flag
  test_emit_broadcasting_disabled_succeeds
  test_emit_any_event_broadcasting_disabled_succeeds
  test_emit_invalid_event_broadcasting_disabled_succeeds

  # emit tests (broadcasting enabled)
  test_emit_enabled_no_event_type_fails
  test_emit_enabled_no_event_shows_usage
  test_emit_enabled_help_flag_shows_usage
  test_emit_enabled_invalid_event_fails
  test_emit_enabled_invalid_event_error_message
  test_emit_enabled_missing_params_fails
  test_emit_enabled_missing_params_error_message

  # socket delegation tests
  test_socket_help_delegation
  test_socket_status_delegation
  test_socket_help_flag_delegation

  # webhook delegation tests
  test_webhook_help_delegation
  test_webhook_status_delegation
  test_webhook_help_flag_delegation

  # unknown command tests
  test_unknown_command_fails
  test_unknown_command_error_message

  log_test_step "Events commands tests completed"

  if print_assert_summary "$TEST_NAME"; then
    pass_test "All events command tests passed"
  else
    fail_test "Some events command tests failed"
  fi
}
