...
function main() {
  log_test_step "Starting execution serialization tests"

  # Initialize test environment
  setup_test

  # Write result tests
  test_write_result_basic
  test_write_result_special_characters
  test_write_result_empty_values

  # Read result tests
  test_read_result_basic
  test_read_result_missing_file
  test_read_result_empty_file

  # Round-trip tests
  test_round_trip_basic
  test_round_trip_with_spaces

  # Flatten tests
  test_flatten_result_basic
  test_flatten_multiple_results

  # Edge case tests
  test_value_with_equals_sign
  test_numeric_field_types

  # Cleanup
  cleanup_test

  log_test_step "Execution serialization tests completed"

  # Print summary and determine exit code
  if print_assert_summary "$TEST_NAME"; then
    pass_test "All execution serialization tests completed successfully"
  else
    fail_test "Some execution serialization tests failed"
  fi
}
