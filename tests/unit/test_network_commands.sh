...
function main() {
  log_test_step "Starting network commands tests"
  ...
  test_help_flag
  test_help_h_flag
  test_help_ports_command
  test_help_ports_check_command
  test_help_ports_kill_command
  test_help_test_port_command
  test_help_ip_command
  ...
  # Ports subcommand routing
  test_ports_no_subcommand
  test_ports_unknown_subcommand
  test_ports_help_flag

  # Ports check
  test_ports_check_missing_port
  test_ports_check_invalid_port_zero
  test_ports_check_invalid_port_too_high
  test_ports_check_invalid_port_text
  test_ports_check_invalid_protocol
  test_ports_check_help
  test_ports_check_valid_port

  # Ports list-used
  test_ports_list_used_help
  test_ports_list_used_invalid_arg
  test_ports_list_used_succeeds

  # Ports conflicts
  test_ports_conflicts_help
  test_ports_conflicts_invalid_arg
  test_ports_conflicts_succeeds_no_instances

  # Ports kill
  test_ports_kill_missing_port
  test_ports_kill_invalid_port_zero
  test_ports_kill_invalid_port_text
  test_ports_kill_help

  # Test-port
  test_test_port_missing_port
  test_test_port_invalid_port_zero
  test_test_port_invalid_port_high
  test_test_port_invalid_port_text
  test_test_port_help
  test_test_port_valid_port_not_listening

  # Test-all
  test_test_all_help
  test_test_all_invalid_arg
  test_test_all_no_instances
  ...
  # DNS
  test_dns_help
  test_dns_invalid_arg
  test_dns_succeeds_or_missing_dep

  log_test_step "Network commands tests completed"

  if print_assert_summary "$TEST_NAME"; then
    pass_test "All network commands tests passed"
  else
    fail_test "Some network commands tests failed"
  fi
}
