...
function main() {
  log_test_step "Starting config commands unit tests"

  setup_test

  # help tests
  test_help_no_args
  test_help_set_command
  test_help_get_command
  test_help_list_command
  test_help_reset_command
  test_help_validate_command
  test_help_edit_command
  test_help_unknown_command

  # list tests
  test_list_outputs_config
  test_list_json_format

  # get tests
  test_get_valid_key
  test_get_nonexistent_key
  test_get_missing_arg

  # set tests
  test_set_valid_key_value
  test_set_invalid_key
  test_set_missing_arg
  test_set_invalid_format

  # validate test
  test_validate_clean_config
  ...
  if print_assert_summary "$TEST_NAME"; then
    pass_test "All config commands unit tests passed"
  else
    fail_test "Some config commands unit tests failed"
  fi
}
