...
function main() {
  log_test_step "Starting lifecycle commands tests"
  ...
  test_help_top_level
  test_help_flag
  test_help_start_command
  test_help_stop_command
  test_help_restart_command
  test_help_status_command
  test_help_is_active_command
  test_help_logs_command
  test_help_unknown_command

  # Missing arguments
  test_start_missing_instance
  test_stop_missing_instance
  test_restart_missing_instance
  test_status_missing_instance
  test_is_active_missing_instance
  test_logs_missing_instance

  # Invalid instances
  test_start_invalid_instance
  test_stop_invalid_instance
  test_restart_invalid_instance
  test_status_invalid_instance
  test_is_active_invalid_instance
  test_logs_invalid_instance

  # Invalid options
  test_start_invalid_option
  test_stop_invalid_option
  test_status_invalid_option
  test_unknown_command
  test_no_command

  # Command-specific help flags
  test_start_help_flag
  test_stop_help_flag
  test_logs_tail_invalid_value

  # Stopped instance behavior
  test_is_active_on_stopped_instance
  test_status_on_stopped_instance
  test_status_json_on_stopped_instance

  log_test_step "Lifecycle commands tests completed"

  if print_assert_summary "$TEST_NAME"; then
    pass_test "All lifecycle commands tests passed"
  else
    fail_test "Some lifecycle commands tests failed"
  fi
}
