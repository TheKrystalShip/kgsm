...
function main() {
  log_test_step "Starting files.management logic tests"

  # Setup
  setup_test

  # __logic_create_container_compose_file() tests
  test_create_container_compose_empty_parameter
  test_create_container_compose_file_not_found
  test_create_container_compose_missing_name
  test_create_container_compose_missing_blueprint_file
  test_create_container_compose_missing_working_dir
  test_create_container_compose_blueprint_not_found
  test_create_container_compose_template_expansion_fails
  test_create_container_compose_readonly_working_dir
  test_create_container_compose_success
  test_create_container_compose_with_env_vars

  # __logic_create_management_file() tests
  test_create_management_file_empty_parameter
  test_create_management_file_config_not_found
  test_create_management_file_missing_name
  test_create_management_file_missing_runtime
  test_create_management_file_missing_management_file
  test_create_management_file_invalid_runtime
  test_create_management_file_copy_fails
  test_create_management_file_chmod_fails
  test_create_management_file_native_success
  test_create_management_file_container_success
  test_create_management_file_replaces_existing
  test_create_management_file_without_overrides
  test_create_management_file_with_overrides
  test_create_management_file_container_compose_fails

  # __logic_remove_management_file() tests
  test_remove_management_file_empty_parameter
  test_remove_management_file_config_not_found
  test_remove_management_file_missing_management_file_field
  test_remove_management_file_readonly_directory
  test_remove_management_file_success
  test_remove_management_file_already_removed
