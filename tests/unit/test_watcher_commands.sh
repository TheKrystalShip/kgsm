...
function main() {
  log_test_step "Starting watcher commands tests"
  ...
  test_help_logs_component
  test_help_ports_component
  ...
  test_status_shows_strategy_info

  # Test command error paths
  test_test_on_instance_with_no_strategy

  # Logs/ports passthrough
  test_logs_passthrough_missing_instance
  test_ports_passthrough_missing_instance
  test_logs_passthrough_invalid_instance
  test_ports_passthrough_invalid_instance

  log_test_step "Watcher commands tests completed"

  if print_assert_summary "$TEST_NAME"; then
    pass_test "All watcher commands tests passed"
  else
    fail_test "Some watcher commands tests failed"
  fi
}
