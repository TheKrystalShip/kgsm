...
function main() {
  log_test_step "Starting blueprint commands tests"
  ...
  log_test_step "Blueprint commands tests completed"

  if print_assert_summary "$TEST_NAME"; then
    pass_test "All blueprint command tests passed"
  else
    fail_test "Some blueprint command tests failed"
  fi
}
