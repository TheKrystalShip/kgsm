...
function main() {
  log_test_step "Starting install commands tests"
  ...
  # Missing argument tests
  test_missing_blueprint_arg
  test_install_dir_missing_value
  test_version_missing_value
  test_name_missing_value

  # Invalid option tests
  test_invalid_option
  test_invalid_option_before_blueprint

  # Module structure tests
  test_module_has_expected_options_in_help
  test_module_shows_examples_in_help

  log_test_step "Install commands tests completed"

  if print_assert_summary "$TEST_NAME"; then
    pass_test "All install commands tests passed"
  else
    fail_test "Some install commands tests failed"
  fi
}
