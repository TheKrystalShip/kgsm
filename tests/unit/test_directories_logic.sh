...
function main() {
  ...
  test_create_file_empty_parameter
  ...
  test_create_directories_missing_config_file
  test_create_directories_missing_working_dir
  test_create_directories_relative_path
  test_create_directories_nonexistent_config
  ...
  test_remove_directories_missing_working_dir
  ...
  if print_assert_summary "$TEST_NAME"; then
    ...
    fail_test "Some directory logic tests failed"
  fi
}
