...
function main() {
  log_test_step "Starting files commands tests"
  ...
  # Component routing tests
  test_management_component_routes_to_submodule
  test_systemd_component_routes_to_submodule
  test_ufw_component_routes_to_submodule
  test_symlink_component_routes_to_submodule
  test_upnp_component_routes_to_submodule

  # Create/remove with valid instance
  test_create_with_valid_instance
  test_remove_with_valid_instance
  test_create_then_remove_cycle

  log_test_step "Files commands tests completed"

  if print_assert_summary "$TEST_NAME"; then
    pass_test "All files commands tests passed"
  else
    fail_test "Some files commands tests failed"
  fi
}
