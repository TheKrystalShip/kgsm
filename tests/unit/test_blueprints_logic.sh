...
function setup_test() {
  log_step "Setting up blueprint logic tests"
  ...
  log_test "Blueprint logic test environment validated"
}
...
function test_get_blueprint_type_native() {
  log_step "Testing __logic_get_blueprint_type with native blueprint"

  local output
  output=$(__logic_get_blueprint_type "factorio")
  local exit_code=$?

  assert_equals "$exit_code" "0" "Should return success for native blueprint"
  assert_equals "$output" "native" "Should identify factorio as native type"
}

function test_get_blueprint_type_container() {
  log_step "Testing __logic_get_blueprint_type with container blueprint"

  local output
  output=$(__logic_get_blueprint_type "vrising")
  local exit_code=$?

  assert_equals "$exit_code" "0" "Should return success for container blueprint"
  assert_equals "$output" "container" "Should identify vrising as container type"
}

function test_get_blueprint_type_not_found() {
  log_step "Testing __logic_get_blueprint_type with non-existent blueprint"
...
function test_get_blueprint_type_empty_param() {
  ...
  assert_equals "$exit_code" "$EC_INVALID_ARG" "Should return invalid argument error"
}
...
function test_validate_blueprint_valid_native() {
  log_step "Testing __logic_validate_blueprint with valid native blueprint"

  __logic_validate_blueprint "terraria" 2> /dev/null
  local exit_code=$?

  assert_equals "$exit_code" "0" "Should validate terraria blueprint successfully"
}

function test_validate_blueprint_valid_container() {
  log_step "Testing __logic_validate_blueprint with valid container blueprint"

  __logic_validate_blueprint "vrising" 2> /dev/null
  local exit_code=$?

  assert_equals "$exit_code" "0" "Should validate vrising blueprint successfully"
}

function test_validate_blueprint_not_found() {
  log_step "Testing __logic_validate_blueprint with non-existent blueprint"
...
function test_get_blueprint_path_native() {
  ...
  assert_equals "$exit_code" "0" "Should return success for starbound"
...
function test_get_blueprint_path_container() {
  ...
  assert_equals "$exit_code" "0" "Should return success for vrising"
...
function test_get_blueprint_path_not_found() {
  log_step "Testing __logic_get_blueprint_path with non-existent blueprint"

  __logic_get_blueprint_path "missing-blueprint" 2> /dev/null
  local exit_code=$?

  assert_equals "$exit_code" "$EC_BLUEPRINT_NOT_FOUND" "Should return blueprint not found error"
}

function test_get_blueprint_path_empty_param() {
  log_step "Testing __logic_get_blueprint_path with empty parameter"
...
function test_get_blueprint_path_permission_denied() {
  log_step "Testing __logic_get_blueprint_path with unreadable blueprint"
  ...
  assert_equals "$exit_code" "$EC_INVALID_BLUEPRINT" "Should return invalid blueprint error for unreadable file"
}
...
function test_list_blueprints_all() {
  log_step "Testing __logic_list_blueprints with 'all' source"

  local output
  output=$(__logic_list_blueprints "all")
  local exit_code=$?

  assert_equals "$exit_code" "$EC_SUCCESS_BLUEPRINT_LISTED" "Should return success code"
...
function test_list_blueprints_default_source() {
  log_step "Testing __logic_list_blueprints with default source parameter"
...
function test_list_blueprints_sorted() {
  log_step "Testing __logic_list_blueprints output is sorted"
  ...
  assert_equals "$output" "$sorted_output" "Output should be sorted alphabetically"
}
...
function test_find_native_blueprint_exists() {
  ...
  assert_equals "$exit_code" "$EC_SUCCESS_BLUEPRINT_FOUND" "Should return success code"
  assert_contains "$output" "factorio.bp" "Path should contain factorio.bp"
  assert_file_exists "$output" "Returned path should exist"
}

function test_find_native_blueprint_with_extension() {
  log_step "Testing __logic_find_native_blueprint with .bp extension"
...
function test_find_native_blueprint_priority() {
  log_step "Testing __logic_find_native_blueprint custom > default priority"
...
EOF
  ...
  assert_equals "$exit_code" "$EC_SUCCESS_BLUEPRINT_FOUND" "Should find custom blueprint"
...
function test_list_native_blueprints_sorted() {
  log_step "Testing __logic_list_native_blueprints output is sorted"
...
function test_get_native_blueprint_info_factorio() {
  log_step "Testing __logic_get_native_blueprint_info with factorio (non-Steam)"

  local output
  output=$(__logic_get_native_blueprint_info "factorio")
  local exit_code=$?

  assert_equals "$exit_code" "$EC_SUCCESS_BLUEPRINT_INFO_RETRIEVED" "Should return success code"
...
function test_get_native_blueprint_info_starbound() {
  log_step "Testing __logic_get_native_blueprint_info with starbound (Steam with account)"
...
function test_get_native_blueprint_info_necesse() {
  log_step "Testing __logic_get_native_blueprint_info with necesse (Steam no account)"
...
function test_get_native_blueprint_info_not_found() {
  log_step "Testing __logic_get_native_blueprint_info with non-existent blueprint"
...
function test_get_native_blueprint_info_permission_denied() {
  log_step "Testing __logic_get_native_blueprint_info with unreadable blueprint"
...
function test_get_native_blueprint_info_output_format() {
  log_step "Testing __logic_get_native_blueprint_info output format"
...
function test_find_container_blueprint_with_extension() {
  log_step "Testing __logic_find_container_blueprint with .docker-compose.yml extension"
...
function test_list_container_blueprints_default() {
  log_step "Testing __logic_list_container_blueprints with 'default' source"
...
function test_list_container_blueprints_custom() {
  ...
  assert_equals "$exit_code" "$EC_SUCCESS_BLUEPRINT_LISTED" "Should return success code (even if empty)"
}
...
function test_get_container_blueprint_info_vrising() {
  log_step "Testing __logic_get_container_blueprint_info with vrising"
...
function test_get_container_blueprint_info_not_found() {
  log_step "Testing __logic_get_container_blueprint_info with non-existent blueprint"
...
function test_get_container_blueprint_info_output_format() {
  log_step "Testing __logic_get_container_blueprint_info output format"
...
function test_get_container_blueprint_info_permission_denied() {
  log_step "Testing __logic_get_container_blueprint_info with unreadable blueprint"
...
function main() {
  log_test "Starting blueprint logic handler tests"
  ...
  log_test "Blueprint logic handler tests completed"
