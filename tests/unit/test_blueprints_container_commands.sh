...
function main() {
  log_test_step "Starting container blueprint commands tests"
  ...
  # info tests
  test_info_container_blueprint
  test_info_container_blueprint_json
  test_info_json_contains_blueprint_type
  ...
  test_find_path_contains_container_dir
  test_find_missing_blueprint_arg
  test_find_invalid_blueprint
  test_find_invalid_option
  test_find_help

  # additional container blueprint tests
  test_list_contains_all_default_container_blueprints
  test_find_another_container_blueprint

  # unknown command test
  test_unknown_command

  log_test_step "Container blueprint commands tests completed"

  if print_assert_summary "$TEST_NAME"; then
    pass_test "All container blueprint command tests passed"
  else
    fail_test "Some container blueprint command tests failed"
  fi
}
