...
function main() {
  log_test_step "Starting config logic tests"

  setup_test

  # __validate_config_key tests
  test_validate_config_key_empty_arg
  test_validate_config_key_unknown_key
  test_validate_config_key_valid_key
  test_validate_config_key_valid_integer_key

  # __validate_config_value tests
  test_validate_config_value_empty_key
  test_validate_config_value_boolean_true
  test_validate_config_value_boolean_false
  test_validate_config_value_boolean_invalid
  test_validate_config_value_boolean_invalid_number
  test_validate_config_value_integer_valid
  test_validate_config_value_integer_zero_invalid
  test_validate_config_value_integer_too_high
  test_validate_config_value_integer_not_numeric
  test_validate_config_value_webhook_retry_zero_valid
  test_validate_config_value_webhook_timeout_valid
  test_validate_config_value_webhook_timeout_exceeds_max

  # __get_config_value tests
  test_get_config_value_empty_file
  test_get_config_value_empty_key
  test_get_config_value_nonexistent_file
  test_get_config_value_unknown_key
  test_get_config_value_known_key_returns_value
  test_get_config_value_from_temp_file

  # __get_config_value_safe tests
  test_get_config_value_safe_empty_key
  test_get_config_value_safe_unknown_key
  test_get_config_value_safe_known_key
  test_get_config_value_safe_integer_key

  # __set_config_value tests
  test_set_config_value_empty_key
  test_set_config_value_unknown_key
  test_set_config_value_invalid_value
  test_set_config_value_valid_boolean
  test_set_config_value_valid_integer
  test_set_config_value_persists_change

  # __get_all_config_keys tests
  test_get_all_config_keys_returns_keys
  test_get_all_config_keys_contains_known_key
  test_get_all_config_keys_no_comments
  test_get_all_config_keys_no_section_headers

  # __list_config_values tests
  test_list_config_values_plain_output
  test_list_config_values_contains_known_key
  test_list_config_values_json_requires_jq

  # __reset_config tests
  test_reset_config_returns_success_code
  test_reset_config_copies_default
  test_reset_config_creates_backup

  # __validate_current_config tests
  test_validate_current_config_clean_config
  test_validate_current_config_after_valid_set

  log_test_step "Config logic tests completed"

  if print_assert_summary "$TEST_NAME"; then
    pass_test "All config logic tests passed"
  else
    fail_test "Some config logic tests failed"
  fi
}
