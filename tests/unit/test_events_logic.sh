...
function main() {
  ...
  test_validate_event_type_empty_returns_error
  test_validate_event_type_all_27_constants
  test_validate_event_type_case_sensitive
  test_validate_event_type_partial_match_fails
  ...
  test_validate_params_invalid_event_type
  test_validate_params_missing_all_params
  test_validate_params_missing_one_param
  test_validate_params_empty_first_param
  test_validate_params_empty_middle_param
  test_validate_params_extra_params_allowed
  test_validate_params_lifecycle_manager_param
  test_validate_params_backup_source_version
  ...
  test_get_param_spec_returns_ec_okay
  test_get_param_spec_invalid_event_type
  test_get_param_spec_empty_param
  test_get_param_spec_lifecycle_events
  test_get_param_spec_backup_events
  test_get_param_spec_output_format_space_separated
  ...
  test_event_name_to_type_invalid_dash_name
  test_event_name_to_type_empty_param
  test_event_name_to_type_already_underscore
  test_event_name_to_type_validates_converted_exists
  test_event_name_to_type_all_27_events
  test_event_name_to_type_mixed_dash_underscore
  test_event_name_to_type_no_output_on_failure
  ...
  if print_assert_summary "$TEST_NAME"; then
    pass_test "All events logic tests completed successfully"
  else
    fail_test "Some events logic tests failed"
  fi
}
