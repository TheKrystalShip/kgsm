...
function test_edge_case_event_count_matches_configs() {
  ...
  log_test_step "Testing EVENT_CONFIGS count matches expected 54 events"

  local config_count="${#EVENT_CONFIGS[@]}"

  assert_equals "$config_count" "54" \
    "EVENT_CONFIGS should contain exactly 54 entries (found: $config_count)"
}
