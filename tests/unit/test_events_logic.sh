...
function test_edge_case_event_count_matches_configs() {
  ...
  log_test_step "Testing EVENT_CONFIGS count matches expected 55 events"

  local config_count="${#EVENT_CONFIGS[@]}"

  assert_equals "$config_count" "55" \
    "EVENT_CONFIGS should contain exactly 55 entries (found: $config_count)"
}
