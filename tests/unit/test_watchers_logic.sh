...
function main() {
  log_test_step "Starting watchers logic handler tests"

  setup_test

  # -----------------------------------------------------------------------
  # watchers.sh - __logic_determine_strategy()
  # -----------------------------------------------------------------------
  log_test_step "Testing __logic_determine_strategy()"
  test_determine_strategy_missing_arg
  test_determine_strategy_file_not_found
  test_determine_strategy_logs_when_regex_configured
  test_determine_strategy_ports_when_only_ports_configured
  test_determine_strategy_no_strategy_when_nothing_configured
  test_determine_strategy_logs_preferred_over_ports
  test_determine_strategy_empty_string_arg

  # -----------------------------------------------------------------------
  # watchers.logs.sh - __logic_test_log_pattern()
  # -----------------------------------------------------------------------
  log_test_step "Testing __logic_test_log_pattern()"
  test_test_log_pattern_missing_arg
  test_test_log_pattern_file_not_found
  test_test_log_pattern_no_pattern_configured
  test_test_log_pattern_log_file_missing
  test_test_log_pattern_pattern_found_in_log
  test_test_log_pattern_pattern_not_found_in_log
  test_test_log_pattern_empty_log_file

  # -----------------------------------------------------------------------
  # watchers.logs.sh - __logic_get_log_status_data()
  # -----------------------------------------------------------------------
  log_test_step "Testing __logic_get_log_status_data()"
  test_get_log_status_data_missing_arg
  test_get_log_status_data_file_not_found
  test_get_log_status_data_returns_success
  test_get_log_status_data_format_when_log_missing
  test_get_log_status_data_format_when_log_exists_with_pattern
  test_get_log_status_data_format_when_log_exists_without_pattern
  test_get_log_status_data_no_pattern_configured

  # -----------------------------------------------------------------------
  # watchers.ports.sh - __logic_extract_first_port()
  # -----------------------------------------------------------------------
  log_test_step "Testing __logic_extract_first_port()"
  test_extract_first_port_missing_arg
  test_extract_first_port_single_port_no_protocol
  test_extract_first_port_single_port_with_protocol
  test_extract_first_port_single_port_tcp_protocol
  test_extract_first_port_range_no_protocol
  test_extract_first_port_range_with_protocol
  test_extract_first_port_multiple_ports_pipe_separated
  test_extract_first_port_multiple_different_ports
  test_extract_first_port_invalid_format
  test_extract_first_port_range_with_udp

  # -----------------------------------------------------------------------
  # watchers.ports.sh - __logic_test_port_status()
  # -----------------------------------------------------------------------
  log_test_step "Testing __logic_test_port_status()"
  test_test_port_status_missing_arg
  test_test_port_status_file_not_found
  test_test_port_status_no_ports_configured
  test_test_port_status_with_ports_returns_success
  test_test_port_status_output_format
  test_test_port_status_range_counts_as_one

  # -----------------------------------------------------------------------
  # watchers.ports.sh - __logic_get_port_status_data()
  # -----------------------------------------------------------------------
  log_test_step "Testing __logic_get_port_status_data()"
  test_get_port_status_data_missing_arg
  test_get_port_status_data_file_not_found
  test_get_port_status_data_returns_success
  test_get_port_status_data_output_contains_ports
  test_get_port_status_data_output_format
  test_get_port_status_data_no_ports_configured

  teardown_test

  log_test_step "Watchers logic handler tests completed"

  if print_assert_summary "$TEST_NAME"; then
    pass_test "All watchers logic tests completed successfully"
  else
    fail_test "Some watchers logic tests failed"
  fi
}
