...
function main() {
  log_test_step "Starting system commands tests"
  ...
  test_help_flag
  test_help_h_flag
  test_help_shutdown_command
  test_help_restart_command
  ...
  # Shutdown argument validation (no sudo required)
  test_shutdown_help
  test_shutdown_invalid_time_text
  test_shutdown_invalid_time_float
  test_shutdown_invalid_time_negative
  test_shutdown_invalid_time_error_message

  # Restart argument validation (no sudo required)
  test_restart_help
  test_restart_help_verb
  test_restart_invalid_time_text
  test_restart_invalid_time_float
  test_restart_unknown_option

  # Cancel argument validation (no sudo required)
  test_cancel_help
  test_cancel_help_verb
  test_cancel_invalid_arg
  test_cancel_unknown_option

  # Uptime
  test_uptime_help
  test_uptime_help_verb
  test_uptime_invalid_arg
  test_uptime_succeeds_or_missing_dep
  test_uptime_output_not_empty

  # Load
  test_load_help
  test_load_invalid_arg
  test_load_succeeds

  # Memory
  test_memory_help
  test_memory_invalid_arg
  test_memory_succeeds_or_missing_dep
  test_memory_output_when_available

  # Disk
  test_disk_help
  test_disk_invalid_arg
  test_disk_succeeds_or_missing_dep
  test_disk_output_when_available

  # Reboot-required
  test_reboot_required_help
  test_reboot_required_help_verb
  test_reboot_required_invalid_arg
  test_reboot_required_unknown_option
  test_reboot_required_succeeds
  test_reboot_required_output_is_informative

  # Info
  test_info_help
  test_info_help_verb
  test_info_invalid_arg
  test_info_unknown_option
  test_info_succeeds
  test_info_json_succeeds_or_missing_dep
  test_info_json_valid_json_when_jq_available
  test_info_json_contains_reboot_field

  log_test_step "System commands tests completed"

  if print_assert_summary "$TEST_NAME"; then
    pass_test "All system commands tests passed"
  else
    fail_test "Some system commands tests failed"
  fi
}
