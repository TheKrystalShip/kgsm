...
function main() {
  log_test_step "Starting directories command tests"

  setup_test

  log_test_step "Running help tests"
  test_help_no_args_shows_usage
  test_help_flag_shows_usage
  test_help_create_subcommand
  test_help_remove_subcommand
  test_help_ensure_created_subcommand
  test_help_unknown_command

  log_test_step "Running ensure-created tests"
  test_ensure_created_creates_directory
  test_ensure_created_idempotent
  test_ensure_created_missing_arg
  test_ensure_created_help_flag

  log_test_step "Running create tests"
  test_create_directories_success
  test_create_missing_instance_arg
  test_create_invalid_instance_name
  test_create_help_flag

  log_test_step "Running remove tests"
  test_remove_directories_success
  test_remove_missing_instance_arg
  test_remove_invalid_instance_name
  test_remove_help_flag

  log_test_step "Running link-instance / unlink-instance tests"
  test_link_instance_success
  test_link_instance_missing_blueprint
  test_link_instance_missing_instance
  test_link_instance_missing_working_dir
  test_unlink_instance_success
  test_unlink_instance_missing_blueprint
  test_unlink_instance_missing_instance

  log_test_step "Running unknown/no command tests"
  test_no_command_returns_error
  test_unknown_command_returns_error

  log_test_step "Directories command tests completed"

  if print_assert_summary "$TEST_NAME"; then
    pass_test "All directories command tests passed"
  else
    fail_test "Some directories command tests failed"
  fi
}
