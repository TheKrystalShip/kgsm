...
function main() {
  log_test_step "Starting uninstall commands tests"
  ...
  # Missing argument tests
  test_missing_instance_arg

  # Invalid option tests
  test_unknown_option
  test_unknown_dash_option

  # Invalid instance tests
  test_invalid_instance

  # Help output structure tests
  test_help_contains_warning
  test_help_contains_examples
  test_help_contains_usage

  log_test_step "Uninstall commands tests completed"

  if print_assert_summary "$TEST_NAME"; then
    pass_test "All uninstall commands tests passed"
  else
    fail_test "Some uninstall commands tests failed"
  fi
}
